        ...
        <div className="row">
            ...
            <div className="col-md-6 col-lg-3 pb-5">
                <div className="h-100 py-5 services-icon-wap shadow">
                    <div className="h1 text-success text-center">
                        <i className="fa fa-truck fa-lg"></i></div>
                    <h2 className="h5 mt-4 text-center">e-Commerce</h2>
                </div>
            </div>
            ...
            <div className="col-md-6 col-lg-3 pb-5">
                <div className="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 className="h5 mt-4 text-center">Custom Site</h2>
                </div>
            </div>
            ...
            <div className="col-md-6 col-lg-3 pb-5">
                <div className="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 className="h5 mt-4 text-center">Mobile Apps</h2>
                </div>
            </div>
            ...
            <div className="col-md-6 col-lg-3 pb-5">
                <div className="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 className="h5 mt-4 text-center">Saas Products</h2>
                </div>
            </div>
        </div>
    </section>
